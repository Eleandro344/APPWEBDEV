...
def carregar_dados_remessa():
        ...
        return unicredtrocados,Ntrocadossafra,safratrocados,Ntrocadossofisa,sofisatrocados,santandertrocados,Ntrocadossicoob,sicoobtrocados,stratton,Ntrocadounicred,Ntrocado_sant,Ntrocadoitau,itautrocados,
...
def layout():
    unicredtrocados,Ntrocadossafra,safratrocados,Ntrocadossofisa,sofisatrocados,santandertrocados,Ntrocadossicoob,sicoobtrocados,stratton,Ntrocadounicred,Ntrocado_sant,Ntrocadoitau,itautrocados = carregar_dados_remessa()
    ...
    html.H3(f'Trocados Santander {santandertrocados}', className='class_css2'),
    html.H3(f'Não trocados santander  {Ntrocado_sant}', className='class_css1'),
    html.Img(src='/assets/logoitau.png', className="logo-imgz", style={'width': '3%'}),
    html.H3(f'Trocados Itau  {itautrocados}', className='class_css2'),
    html.H3(f'Não trocados Itau  {Ntrocadoitau}', className='class_css1'),
    html.Img(src='/assets/unicredimagem.png', className="logo-imgz", style={'width': '8%'}),
    html.H3(f'Trocados unicred  {unicredtrocados}', className='class_css2'),

    html.H3(f'Não Trocados unicred  {Ntrocadounicred}', className='class_css1'),
    html.Img(src='/assets/stratton.png', className="logo-imgz", style={'width': '8%'}),
    html.H3(f'Trocados Stratton  {stratton}', className='class_css2'),
    html.Img(src='/assets/sicoob.png', className="logo-imgz", style={'width': '4%'}),
    html.H3(f'Trocados Sicoob  {sicoobtrocados}', className='class_css2'),
    html.H3(f'Não Trocados Sicoob  {Ntrocadossicoob}', className='class_css1'),
    html.Img(src='/assets/Sofisaimagem.png', className="logo-imgz", style={'width': '8%'}),
    html.H3(f'Trocados Sofisa  {sofisatrocados}', className='class_css2'),
    html.H3(f'Não Trocados Sofisa  {Ntrocadossofisa}', className='class_css1'),   
    html.Img(src='/assets/bancosafra.png', className="logo-imgz", style={'width': '8%'}),
    html.H3(f'Trocados Safra  {safratrocados}', className='class_css2'),
    html.H3(f'Não Trocados Safra  {Ntrocadossafra}', className='class_css1'),
