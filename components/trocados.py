...
def layout():
    return html.Div([
        html.H1("Situação Bancos (Não esta incluso Garantia de OP)",className="text-titulo", style={'margin-top': '30px','margin-left':'20px'}),#'margin-top': '10px', 'fontSize': 25, 'fontFamily': 'Calibri', 'fontWeight': 'bold', 'color': 'black', 'textAlign': 'left', 'marginBottom': '20px'}),
